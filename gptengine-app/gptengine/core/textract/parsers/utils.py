...
from pdf2image.core.textract.parsers import exception
    ...
    def run(self, args):
        ...
        try:
            ...
            if e.errno == errno.ENOENT:
                ...
                raise exception.ShellError(" ".join(args), 127, "", "")
        ...
        if pipe.returncode != 0:
            raise exception.ShellError(" ".join(args), pipe.returncode, stdout, stderr)
